...
<body>
    ...
    <section class="section featured-section" id="cars">
        <div class="section-container">
            <div class="section-header">
                ...
                <a href="#" class="section-link">View All Cars →</a>
            </div>
            ...
            <div class="car-grid" id="carGrid">
                ...
                <div class="car-card" onclick="openCarDetail('1')">
                    ...
                    <div class="car-card-body">
                        ...
                        <p class="car-card-subtitle">Sedan • Automatic • Petrol</p>
                        <div class="car-card-features">
                            <span class="car-feature">👤 5 seats</span>
                            <span class="car-feature">⛽ 7L/100km</span>
                            <span class="car-feature">📍 GPS</span>
                            <span class="car-feature">❄️ A/C</span>
                        </div>
                ...
                <div class="car-card" onclick="openCarDetail('2')">
                    ...
                    <div class="car-card-body">
                        ...
                        <p class="car-card-subtitle">Luxury • Automatic • Petrol</p>
                        <div class="car-card-features">
                            <span class="car-feature">👤 5 seats</span>
                            <span class="car-feature">⛽ 6.5L/100km</span>
                            <span class="car-feature">📍 GPS</span>
                            <span class="car-feature">🎵 Premium</span>
                        </div>
                        <div class="car-card-footer">
                            <div class="car-card-price">
                ...
                <div class="car-card" onclick="openCarDetail('3')">
                    ...
                    <div class="car-card-body">
                        ...
                        <p class="car-card-subtitle">Electric • Automatic • EV</p>
                        <div class="car-card-features">
                            <span class="car-feature">👤 5 seats</span>
                            <span class="car-feature">🔋 358mi</span>
                            <span class="car-feature">📍 GPS</span>
                            <span class="car-feature">🤖 Autopilot</span>
                        </div>
                        <div class="car-card-footer">
                            <div class="car-card-price">
                ...
                <div class="car-card" onclick="openCarDetail('4')">
                    ...
                    <div class="car-card-body">
                        ...
                        <p class="car-card-subtitle">SUV • Automatic • Diesel</p>
                        <div class="car-card-features">
                            <span class="car-feature">👤 5 seats</span>
                            <span class="car-feature">⛽ 8L/100km</span>
                            <span class="car-feature">📍 GPS</span>
                            <span class="car-feature">🏔️ 4WD</span>
                        </div>
                        <div class="car-card-footer">
                            <div class="car-card-price">
    ...
    <section class="section" style="background:var(--gray-100);" id="promotions">
        <div class="section-container">
            <div class="section-header">
                ...
                <a href="#" class="section-link">All Promotions →</a>
            </div>
        ...
        <div class="section-container">
            ...
            <div class="community-grid">
                <div class="community-post">
                    <div class="community-post-image">🏖️</div>
                    <div class="community-post-body">
                        ...
                        <div class="community-post-actions">
                            <button class="community-action" onclick="likePost(this)">❤️ 42</button>
                            <button class="community-action">💬 12</button>
                ...
                <div class="community-post">
                    ...
                    <div class="community-post-body">
                        ...
                        <div class="community-post-actions">
                            <button class="community-action" onclick="likePost(this)">❤️ 89</button>
                            <button class="community-action">💬 34</button>
                            <button class="community-action">🔗 Share</button>
                        </div>
                    </div>
                </div>
                <div class="community-post">
                    <div class="community-post-image">🌆</div>
                    <div class="community-post-body">
                        <div class="community-post-author">
                            <div class="community-avatar">👤</div>
                            <div>
                        ...
                        <div class="community-post-actions">
                            <button class="community-action" onclick="likePost(this)">❤️ 156</button>
                            <button class="community-action">💬 48</button>
                            <button class="community-action">🔗 Share</button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-overlay" id="carDetailModal">
        <div class="modal" style="max-width:640px;">
            <div class="modal-header">
                ...
                <button class="modal-close" onclick="closeModal('carDetailModal')">✕</button>
            </div>
            <div class="modal-body" id="modalCarBody">
                <div style="text-align:center;font-size:6rem;padding:32px;background:var(--gray-50);border-radius:var(--radius-md);margin-bottom:24px;" id="modalCarImage">🚗</div>
    ...
    <script>
        ...
        // ===== CAR DETAILS =====
        const carData = {
            '1': { title: 'Toyota Camry 2025', emoji: '🚗', seats: '5', transmission: 'Automatic', fuel: 'Petrol', price: '$65/day' },
            '2': { title: 'BMW 3 Series 2025', emoji: '🏎️', seats: '5', transmission: 'Automatic', fuel: 'Petrol', price: '$120/day' },
            '3': { title: 'Tesla Model 3 2025', emoji: '⚡', seats: '5', transmission: 'Automatic', fuel: 'Electric', price: '$95/day' },
            '4': { title: 'Mercedes GLC 2025', emoji: '🚙', seats: '5', transmission: 'Automatic', fuel: 'Diesel', price: '$145/day' },
        };
        ...
        function toggleChatbot() {
            ...
            document.getElementById('chatbotToggle').textContent = window.classList.contains('open') ? '✕' : '💬';
        }
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        if (data.context_used) {
                            console.log('💾 Memory context was used to improve response');
                        }
                    } else {
