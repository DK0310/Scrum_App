...
async function showUserProfile(userId) {
    ...
    try {
        ...
        const roleBadge = u.role === 'admin' ? '<span style="background:#ef4444;color:white;padding:2px 10px;border-radius:12px;font-size:0.7rem;font-weight:600;">ADMIN</span>'
            : u.role === 'controlstaff' ? '<span style="background:#7c3aed;color:white;padding:2px 10px;border-radius:12px;font-size:0.7rem;font-weight:600;">CONTROL STAFF</span>'
            : u.role === 'callcenterstaff' ? '<span style="background:#0f766e;color:white;padding:2px 10px;border-radius:12px;font-size:0.7rem;font-weight:600;">CALL CENTER</span>'
            : u.role === 'driver' ? '<span style="background:#f59e0b;color:white;padding:2px 10px;border-radius:12px;font-size:0.7rem;font-weight:600;">DRIVER</span>'
            : '<span style="background:var(--gray-200);color:var(--gray-700);padding:2px 10px;border-radius:12px;font-size:0.7rem;font-weight:600;">USER</span>';
